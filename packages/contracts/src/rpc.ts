...
export const WS_METHODS = {
  ...
  previewIssueGateway: "preview.issueGateway",
...
const WsPreviewIssueGatewayRpc = Rpc.make(WS_METHODS.previewIssueGateway, {
  payload: PreviewGatewayIssueInput,
  success: PreviewGatewayGrant,
