...
export const RunAllocationId = makeEntityId("RunAllocationId");
export type RunAllocationId = typeof RunAllocationId.Type;
export const CloudAgentId = makeEntityId("CloudAgentId");
export type CloudAgentId = typeof CloudAgentId.Type;
export const CloudRunId = makeEntityId("CloudRunId");
export type CloudRunId = typeof CloudRunId.Type;
export const CloudRuntimeAttemptId = makeEntityId("CloudRuntimeAttemptId");
export type CloudRuntimeAttemptId = typeof CloudRuntimeAttemptId.Type;
export const CloudEnvironmentId = makeEntityId("CloudEnvironmentId");
export type CloudEnvironmentId = typeof CloudEnvironmentId.Type;
export const CloudEnvironmentVersionId = makeEntityId("CloudEnvironmentVersionId");
export type CloudEnvironmentVersionId = typeof CloudEnvironmentVersionId.Type;
export const CloudEnvironmentBuildId = makeEntityId("CloudEnvironmentBuildId");
export type CloudEnvironmentBuildId = typeof CloudEnvironmentBuildId.Type;
export const CloudMacHostId = makeEntityId("CloudMacHostId");
export type CloudMacHostId = typeof CloudMacHostId.Type;
export const CloudWarmGuestId = makeEntityId("CloudWarmGuestId");
export type CloudWarmGuestId = typeof CloudWarmGuestId.Type;
export const CloudHandoffTransferId = makeEntityId("CloudHandoffTransferId");
export type CloudHandoffTransferId = typeof CloudHandoffTransferId.Type;
export const RunWorkerId = makeEntityId("RunWorkerId");
