...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.cloudAgentReviewLease]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudAgentReviewShare]: AuthOrchestrationReadScope,
  [WS_METHODS.cloudExpoMetroInspect]: AuthOrchestrationReadScope,
  [WS_METHODS.cloudExpoMetroControl]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.deviceDisplayIssue]: AuthOrchestrationReadScope,
  [WS_METHODS.deviceDisplayKeepAlive]: AuthOrchestrationReadScope,
  [WS_METHODS.deviceDisplayTakeControl]: AuthOrchestrationOperateScope,
  [WS_METHODS.deviceDisplayReturnControl]: AuthOrchestrationOperateScope,
  [WS_METHODS.deviceDisplayRelease]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.subscribeCloudAllocations]: AuthOrchestrationReadScope,
