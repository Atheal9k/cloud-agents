...
function fixture(initial: RunAllocation, options?: { readonly captureFails?: boolean }) {
  return Effect.gen(function* () {
    ...
    const controller = CloudAllocationController.CloudAllocationController.of({
      ...
      setDefaults: () => Effect.die("unused"),
      setSpendLimit: () => Effect.die("unused"),
      recordInvoice: () => Effect.die("unused"),
      exportUsage: () => Effect.die("unused"),
      listAudit: () => Effect.die("unused"),
      recordAdminAudit: () => Effect.die("unused"),
      refresh: Effect.die("unused"),
      saveBuild: () => Effect.die("unused"),
      activateBuild: () => Effect.die("unused"),
